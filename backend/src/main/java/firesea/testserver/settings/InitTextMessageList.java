...
public class InitTextMessageList {
    ...
    @PostConstruct
    public void init() {
        memberService.save(new Member("aaaa1111", passwordEncoder.encode("11111111"), "aaa@naver.com", "백엔드개발자"));
        memberService.save(new Member("bbbb2222", passwordEncoder.encode("22222222"), "bbb@naver.com", "프론트개발자"));
        memberService.save(new Member("cccc3333", passwordEncoder.encode("33333333"), "ccc@naver.com", "플로버1"));
        memberService.save(new Member("dddd4444", passwordEncoder.encode("44444444"), "ddd@naver.com", "플로버2"));
        memberService.save(new Member("eeee5555", passwordEncoder.encode("55555555"), "eee@naver.com", "플로버3"));
        memberService.save(new Member("ffff6666", passwordEncoder.encode("66666666"), "fff@naver.com", "플로버4"));
        memberService.save(new Member("gggg7777", passwordEncoder.encode("77777777"), "ggg@naver.com", "플로버5"));
        memberService.save(new Member("hhhh8888", passwordEncoder.encode("88888888"), "hhh@naver.com", "플로버6"));
        memberService.save(new Member("iiii9999", passwordEncoder.encode("99999999"), "iii@naver.com", "플로버7"));
        memberService.save(new Member("jjjj0000", passwordEncoder.encode("00000000"), "jjj@naver.com", "플로버8"));
